		...
		echo'
			<div class="col-75">
				...
				<input type="hidden" name="total_count" value="'.$total_count.'">
					...
					<button type="button" id="payBtn" class="checkout-btn">Pay Now</button>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    document.getElementById("payBtn").addEventListener("click", function (e) {
        ...
        fetch("/PHP/online-shopping-system-master/create_order.php", {
            method: "POST",
        ...
        .then(order => {
            ...
            alert("Order Created ✅"); // DEBUG

            var options = {
                key: "rzp_test_Sbu4puTfZXI9y9",
                amount: order.amount,
                currency: "INR",
                name: "RishavPatel",
